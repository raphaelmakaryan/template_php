...
function validateForm($post)
{
    ...
    } else if (filter_has_var(INPUT_POST, 'categorySelectMdf') && !in_array($post['categorySelectMdf'], ['test']) && filter_input(INPUT_POST, 'categorySelectMdf', FILTER_SANITIZE_SPECIAL_CHARS)) {
